...
class BaseClient:
    def __init__(self, client_id: int, last_name: str, first_name: str, otch: str = None):
...
class Client(BaseClient):
    ...
    def __init__(self, client_id, last_name, first_name, address, phone, driver_license, otch=None, email=None):
        super().__init__(client_id, last_name, first_name, otch)
...
class ClientShort(BaseClient):
    ...
    def __init__(self, client: Client):
        super().__init__(client.client_id, client.last_name, client.first_name, client.otch)
        self._contact = client.email if client.email else client.phone
